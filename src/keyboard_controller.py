...
class KeyboardController:
    def __init__(self, config_path: str = "config/simulation_config.yaml"):
        ...
        self.gripper_force = np.array(keyboard_config['gripper_open_force'], dtype=np.float64)
        
        # 配置中的夹爪力设置
        self.gripper_close_force = np.array(keyboard_config['gripper_close_force'], dtype=np.float64)
        self.gripper_open_force = np.array(keyboard_config['gripper_open_force'], dtype=np.float64)
